...
export default function GameCard({ title, description, link, Icon, ctaText = "Play Game" }: GameCardProps) {
  return (
    <Card className="w-full max-w-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl bg-card rounded-xl overflow-hidden">
      ...
      <CardContent className="p-6 pt-0">
        <CardDescription className="font-body text-base text-foreground/80 min-h-[60px]">{description}</CardDescription>
      </CardContent>
